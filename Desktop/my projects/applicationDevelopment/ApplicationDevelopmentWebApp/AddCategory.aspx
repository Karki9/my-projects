<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCategory.aspx.cs" Inherits="ApplicationDevelopmentWebApp.AddCategory" %>
...
<body>
    <form id="form2" runat="server">
                ...
                <div class="nav-wrapper teal lighten-2">
                    ...
                    <ul class="side-nav grey darken-2" id="mobile-demo" style="transform: translateX(-100%);">
                        ...
                        <li class="sidenav-header blue">
                            <div class="row">
                                <div class="col s8">
                                    <a class="btn-flat dropdown-button waves-effect waves-light white-text" href="#" data-activates="profile-dropdown"><asp:Label runat="server" ID="headerText"></asp:Label><i class="mdi-navigation-arrow-drop-down right"></i></a>
        ...
        <div class="container">
            Category ID
            <asp:TextBox ID="categoryId" class="validate" runat="server"></asp:TextBox>
            Category Name
            <asp:TextBox ID="categoryName" class="validate" runat="server"></asp:TextBox>

            <asp:Button ID="btn_Category" runat="server" CssClass="btn waves-effect" Text="Insert" OnClick="btn_Category_Click" />
        </div>
    </form>
