<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerSearch.aspx.cs" Inherits="ApplicationDevelopmentWebApp.CustomerSearch" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="container">
            <asp:TextBox ID="customerSearchTB" runat="server"></asp:TextBox>
            <asp:Button ID="btnSearch" runat="server" Text="Button" OnClick="btn_Search" /> <asp:Button ID="clearSearch" runat="server" Text="btn_Clear" />
            <asp:Label ID="tblCustomerSearch" runat="server"></asp:Label>
        </div>
