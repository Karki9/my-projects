<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStock.aspx.cs" Inherits="ApplicationDevelopmentWebApp.AddStock" %>
...
<nav>
    <div class="nav-wrapper teal lighten-2">
      <a href="#" data-activates="mobile-demo" class="button-collapse show-on-large"><i class="material-icons">menu</i></a>
        <div class="center-align center" style="margin-top: -12px; padding-top: 10px;"> <h5> Add Stock</h5> </div> 
      ...
      <ul class="side-nav grey darken-2" id="mobile-demo" style="transform: translateX(-100%);">
        ...
        <li class="sidenav-header blue">
          <div class="row">
            <div class="col s8">
                <a class="btn-flat dropdown-button waves-effect waves-light white-text" href="#" data-activates="profile-dropdown"><asp:Label ID="headerText" runat="server"></asp:Label><i class="mdi-navigation-arrow-drop-down right"></i></a><ul id="profile-dropdown" class="dropdown-content" style="white-space: nowrap; position: absolute; top: 23.2222px; left: 115.618px; opacity: 1; display: none;">
    ...
    <div class="container">
        ID<asp:TextBox ID="stockId" CssClass="validate" required="" aria-required="true"  runat="server"></asp:TextBox>
        Name<asp:TextBox ID="stockName" CssClass="validate" required="" aria-required="true"  runat="server"></asp:TextBox>
        Quantity<asp:TextBox ID="stockQty" CssClass="validate" required="" aria-required="true" runat="server"></asp:TextBox>
        Price<asp:TextBox ID="stockPrice" CssClass="validate" required="" aria-required="true"  runat="server"></asp:TextBox>
        Date<asp:TextBox CssClass="datepicker validate" required="" aria-required="true"  ID="stockDate" runat="server"></asp:TextBox>
        Product Name <asp:DropDownList style="display:block; width:auto;" runat="server" ID="productDD"></asp:DropDownList>        
        <asp:Button ID="Button1" runat="server" CssClass="btn waves-effect" OnClick="Button1_Click" Text="Insert"/>
    

    
        <div class="container highlight">
            <asp:Label ID="lblTable" CssClass="centered" runat="server"></asp:Label>
        </div>
