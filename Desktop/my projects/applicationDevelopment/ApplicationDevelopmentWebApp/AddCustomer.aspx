<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCustomer.aspx.cs" Inherits="ApplicationDevelopmentWebApp.AddCustomer" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="container">
            ...
            <div class="container">
                Gender
            <asp:RadioButtonList ID="customerGenderRB" runat="server">
                <asp:ListItem Value="Male"> Male </asp:ListItem>
                <asp:ListItem Value="Female"> Female </asp:ListItem>
            </asp:RadioButtonList>
            </div>
            <div class="container">
                <asp:Button ID="Button1" CssClass="btn waves" runat="server" OnClick="Button1_Click" Text="Save" />
            </div>
