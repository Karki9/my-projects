<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchProduct.aspx.cs" Inherits="ApplicationDevelopmentWebApp.SearchProduct" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="container">
            <div class="container">
                <asp:DropDownList Style="display: block; width: auto" runat="server"></asp:DropDownList>
            </div>
            <div class="container">
        ...
        <div class="container">
            <asp:Button CssClass="btn" ID="SearchBtn" runat="server" Text="Button" OnClick="SearchBtn_Click" />
            <asp:Button CssClass="btn" ID="clearBtn" runat="server" Text="Clear" OnClick="clearBtn_Click" />
            <asp:TextBox ID="userNameLabel" runat="server"></asp:TextBox>
        </div>
    </form>
