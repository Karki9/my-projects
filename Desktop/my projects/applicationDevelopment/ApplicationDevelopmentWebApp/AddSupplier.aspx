<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSupplier.aspx.cs" Inherits="ApplicationDevelopmentWebApp.AddSupplier" %>
...
<nav>
    <div class="nav-wrapper teal lighten-2">
      <a href="#" data-activates="mobile-demo" class="button-collapse show-on-large"><i class="material-icons">menu</i></a>
        <div class="center-align center" style="margin-top: -12px; padding-top: 10px;"> <h5> Add Supplier </h5> </div> 
    ...
    <div class="container">
        Supplier ID: <asp:TextBox CssClass="input-field" ID="supplierId" runat="server"></asp:TextBox>
        First Name: <asp:TextBox CssClass="input-field" ID="supplierFirstName" runat="server"></asp:TextBox>
        Last Name: <asp:TextBox CssClass="input-field" ID="supplierLastName" runat="server"></asp:TextBox>
        Supplier Address: <asp:TextBox CssClass="input-field" ID="supplierAddress" runat="server"></asp:TextBox>
        <div class="container">
            <p> Gender </p>
            <asp:RadioButtonList  ID="supplierGenderRB" runat="server">            
                      <asp:ListItem Value="Male"> Male </asp:ListItem>
                      <asp:ListItem Value="Female"> Female </asp:ListItem>
            </asp:RadioButtonList>
         </div>
        Product ID: <asp:DropDownList style="display:block; width:auto" ID="supplierProductDropDown" runat="server"></asp:DropDownList>
