...
import com.example.khadka.ui1.Misc.DataParserRoute;
...
public class Route_Finder extends FragmentActivity implements OnMapReadyCallback, 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.khadka.ui1.R.layout.activity_route__finder);
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            checkLocationPermission();
        }

        Map_type_Switch =(Switch)findViewById(R.id.switch3);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng point) {
                 ...
                 */
                if (MarkerPoints.size() == 1) {
                    Toast.makeText(Route_Finder.this, "Origin Selected", Toast.LENGTH_LONG).show();
                    options.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
                } else if (MarkerPoints.size() == 2) {
                    Toast.makeText(Route_Finder.this, "Destination Selected", Toast.LENGTH_LONG).show();
